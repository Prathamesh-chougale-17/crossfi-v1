...
import { normalizeWalletAddress, isValidWalletAddress } from './validation';
...
export function WalletProvider({ children }: WalletProviderProps) {
  ...
  const normalizedAddress = address && isValidWalletAddress(address) 
 ...
 */
interface UseRequireWalletOptions {
...
export function useRequireWallet(options: UseRequireWalletOptions = {}): UseRequireWalletReturn {
  const {
 ...
 */
interface WithWalletRequiredProps {
...
export function withWalletRequired<P extends object>(
  ...
  return function WalletRequiredComponent(props: P) {
    const { isConnected, isLoading, shouldShowConnectPrompt, promptConnection } = useRequireWallet();
