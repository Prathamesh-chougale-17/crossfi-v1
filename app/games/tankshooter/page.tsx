...
import { GameCanvas } from "@/components/games/tankshooter/game-canvas";
...
export default function HomePage() {
    ...
    const playModes = [
        ...
        },
        {
            ...
            description: "8-player tournament - Free to play!",
            icon: "🏆",
        },
        {
            id: "bots",
    ...
    const startGame = async () => {
        ...
        toast.success("Starting game...", {
            description: `${modeText} - Welcome to the battlefield, commander!`,
            duration: 2000,
        });
                            ...
                            <div className="relative">
                                <CardTitle className="text-7xl font-black mb-6 tracking-wider relative">
                                    ...
                                    <div className="absolute -top-3 -right-16 flex items-center gap-2">
                                        <div
                                            className={`w-4 h-4 rounded-full border-2 ${isConnected
                                        ...
                                        ></div>
                                        <span
                                            className={`text-xs font-bold uppercase tracking-wider ${isConnected ? "text-emerald-400" : "text-slate-400"
                                                }`}
                                        >
                                ...
                                <div className="relative">
                                    ...
                                    <p className="text-sm text-slate-400 font-medium">
                                        Free to play • No payments required
                                    </p>
                                </div>
                            </div>
                        </CardHeader>
                        ...
                        <CardContent className="space-y-10 relative z-10 px-8 pb-8">
                                            ...
                                            <SelectContent className="bg-slate-900/95 border-2 border-purple-500/30 backdrop-blur-xl rounded-xl shadow-2xl shadow-purple-500/20">
                                                {playModes.map((mode) => (
                                                    <SelectItem
                                                        ...
                                                        className={`focus:bg-purple-500/20 hover:bg-purple-500/10 cursor-pointer transition-all duration-200 rounded-lg mx-2 my-1 p-4 ${mode.id === "multiplayer" && !isConnected
                            ...
                            <div className="pt-4">
                                ...
                                <p className="text-center text-slate-400 text-sm mt-4 bg-slate-800/30 rounded-lg p-3 border border-slate-600/30">
                                    🎮 Free to play tank battle arena - No payments required!
                                </p>
                            </div>
                            ...
                            <div className="grid grid-cols-3 gap-6 pt-8">
                                <div className="text-center group cursor-pointer transform hover:scale-105 transition-all duration-300">
                                    <div
                                        className={`relative overflow-hidden rounded-2xl p-6 backdrop-blur-sm border transition-all duration-500 ${isConnected
                                    ...
                                    >
                                        ...
                                        <Users
                                            className={`h-12 w-12 mx-auto mb-4 transition-all duration-300 ${isConnected
                                        ...
                                        <div
                                            className={`text-3xl font-black mb-2 ${isConnected
                                ...
                                <div className="text-center group cursor-pointer transform hover:scale-105 transition-all duration-300">
                                    ...
                                    >
                                        ...
                                        <div
                                            className={`text-xs font-semibold px-3 py-1 rounded-full ${isConnected
