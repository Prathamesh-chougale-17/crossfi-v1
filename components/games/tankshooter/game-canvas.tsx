...
export function GameCanvas({
    ...
    useEffect(() => {
        ...
        if (gameStats.isRegenerating !== prevStats.isRegenerating) {
            console.log(
                `Health regeneration: ${gameStats.isRegenerating ? "STARTED" : "STOPPED"
                }`
            );
        }
        ...
        >
            ...
            <div className="absolute inset-0 pointer-events-none">
                        ...
                        <Card className="bg-black/50 border-white/20 px-4 py-2">
                            <div className="text-white text-sm">
                                <div className="flex items-center gap-4">
                                    <div
                                        className={`text-center font-mono px-3 py-1 rounded-md flex items-center ${timeRemaining <= 5
                ...
                <div className="absolute bottom-6 left-1/2 transform -translate-x-1/2 pointer-events-auto">
                    <Card
                        className={`bg-black/50 border-white/20 px-2 py-1 gap-0 ${gameStats.health <= 0 ? "border-red-500/50" : ""
                            }`}
                    >
                        ...
                        <div className="relative w-36 mb-1">
                            <Progress
                                ...
                                className={`h-3 ${healthPercentage > 75
                ...
                <div className="absolute bottom-4 right-4 pointer-events-auto flex flex-col gap-1">
                    <div
                        className={`px-2 py-1 rounded-full text-xs font-medium ${isConnected && playMode === "multiplayer"
